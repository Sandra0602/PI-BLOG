                    ...
                    <tbody>
                        <?php foreach ($data as $dat) { ?>
                            <tr data-id="<?php echo $dat['id']; ?>">
                                <td class="border px-4 py-2"><?php echo $dat['id'] ?></td>
                                <td class="border px-4 py-2"><?php echo $dat['contenido'] ?></td>
                                <td class="border px-4 py-2"><?php echo $dat['titulo'] ?></td>
                                <td class="border px-4 py-2"><?php echo $dat['fecha'] ?></td>
                                <td class="border px-4 py-2"><?php echo $dat['Nombre'] ?></td>
                                <td>
