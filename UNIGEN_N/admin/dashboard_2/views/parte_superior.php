...
<link rel="shortcut icon" href="img_fem/logo_oficial-fotor-2024051017195.png" type="">
    ...
    <!-- Enlaces a las bibliotecas de DataTables y estilos -->
    <link href="https://cdn.datatables.net/1.11.5/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="https://cdn.datatables.net/1.11.5/css/dataTables.bootstrap5.min.css" rel="stylesheet">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>

    <link rel="stylesheet" type="text/css" href="styles_css/tabla.css">
    <link rel="stylesheet" href="styles_css/dashboard.css">
    <link rel="stylesheet" href="styles_css/publi.css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
        <a class="nav-link collapsed btn" href="#" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <!-- Dropdown - Messages   -----MENSAJES____ -->
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!-- Dropdown - Alerts 
                            down-menu dropdown-menu-right shadow animated--grow-in"
